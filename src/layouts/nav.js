                  ...
                  <div className="md:flex md:items-center">
                    {!this.props.user && 
                      <>
                          ...
                          <button className="ml-8 shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white py-1 px-2" type="submit">
                            Login
                          </button>
                          <button 
                          type="button"
                          onClick={this.showModalRegister}
                          className="ml-2 shadow bg-red-500 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-1 px-2"
                          >
                              Register
                          </button>
                      </>
...

                    {
                      ...
                      <>
                        ...
                        <button 
                          ...
                          type="button"
                          className="ml-8 shadow bg-blue-500 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-1 px-2">
                          Share a movies 
                        </button>
                        <button 
                          type="button"
                          onClick={this.props.signOut}
                          className="ml-2 shadow bg-gray-500 hover:bg-gray-400 focus:shadow-outline focus:outline-none text-white font-bold py-1 px-2">
                          Logout
                        </button>
                      </>
                    }
