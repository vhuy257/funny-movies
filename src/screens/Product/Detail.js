...
const Detail = (props) => {
    ...
    const changeQty = (params) => {
        if(params === 'plus') {
            setQty({value: parseInt(qty.value + 1)})
        } else {
            if(qty.value === 1) {
                return false;
            }
                    ...
                    <div className="w-3/6 px-4">
                        ...
                        <div className="flex items-center content-center border-t border-gray-200">
                            <div className="quantity">
                                <button className="minus outline-none" onClick={() => {changeQty('minus')}}><i className="icon-minus"></i></button>
                                ...
                                <button className="plus outline-none" onClick={() => {changeQty('plus')}}><i className="icon-plus"></i></button>
                            </div>
